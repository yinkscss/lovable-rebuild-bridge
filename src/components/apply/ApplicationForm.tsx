  ...
  return <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="mt-12 pt-8 border-t border-gray-200">
        <div className="flex justify-center space-x-8">
          ...
          <img alt="BBB Accredited" className="h-12 object-contain" src="https://start.nationaldebtrelief.com/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2F5xdc9rzhmhnq%2F5tJzAk64KVtKPW0nJifBB0%2Feec2e8a4260d5e08b7dafa41e80b06eb%2Fimage__9_.png%3Fw%3D120%26fm%3Dwebp%26fit%3Dfill&w=256&q=75" />
        </div>
      </div>
    </div>;
};
